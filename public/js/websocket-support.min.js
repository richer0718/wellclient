...
//stomp.min.js
(function(){var t,n,e,r,i={}.hasOwnProperty,o=[].slice;t={LF:"\n",NULL:"\x00"},e=function(){function n(t,n,e){this.command=t,this.headers=null!=n?n:{},this.body=null!=e?e:""}var e;return n.prototype.toString=function(){var e,r,o,s,u;e=[this.command],o=this.headers["content-length"]===!1?!0:!1,o&&delete this.headers["content-length"],u=this.headers;for(r in u)i.call(u,r)&&(s=u[r],e.push(""+r+":"+s));return this.body&&!o&&e.push("content-length:"+n.sizeOfUTF8(this.body)),e.push(t.LF+this.body),e.join(t.LF)},n.sizeOfUTF8=function(t){return t?encodeURI(t).match(/%..|./g).length:0},e=function(e){var r,i,o,s,u,a,c,h,f,p,l,d,g,b,m,v,y;for(s=e.search(RegExp(""+t.LF+t.LF)),u=e.substring(0,s).split(t.LF),o=u.shift(),a={},d=function(t){return t.replace(/^\s+|\s+$/g,"")},v=u.reverse(),g=0,m=v.length;m>g;g++)p=v[g],h=p.indexOf(":"),a[d(p.substring(0,h))]=d(p.substring(h+1));if(r="",l=s+2,a["content-length"])f=parseInt(a["content-length"]),r=(""+e).substring(l,l+f);else for(i=null,c=b=l,y=e.length;(y>=l?y>b:b>y)&&(i=e.charAt(c),i!==t.NULL);c=y>=l?++b:--b)r+=i;return new n(o,a,r)},n.unmarshall=function(n){var r,i,o,s;return i=n.split(RegExp(""+t.NULL+t.LF+"*")),s={frames:[],partial:""},s.frames=function(){var t,n,o,s;for(o=i.slice(0,-1),s=[],t=0,n=o.length;n>t;t++)r=o[t],s.push(e(r));return s}(),o=i.slice(-1)[0],o===t.LF||-1!==o.search(RegExp(""+t.NULL+t.LF+"*$"))?s.frames.push(e(o)):s.partial=o,s},n.marshall=function(e,r,i){var o;return o=new n(e,r,i),o.toString()+t.NULL},n}(),n=function(){function n(t){this.ws=t,this.ws.binaryType="arraybuffer",this.counter=0,this.connected=!1,this.heartbeat={outgoing:1e4,incoming:1e4},this.maxWebSocketFrameSize=16384,this.subscriptions={},this.partialData=""}var i;return n.prototype.debug=function(t){var n;return"undefined"!=typeof window&&null!==window&&null!=(n=window.console)?n.log(t):void 0},i=function(){return Date.now?Date.now():(new Date).valueOf},n.prototype._transmit=function(t,n,r){var i;for(i=e.marshall(t,n,r),"function"==typeof this.debug&&this.debug(">>> "+i);;){if(!(i.length>this.maxWebSocketFrameSize))return this.ws.send(i);this.ws.send(i.substring(0,this.maxWebSocketFrameSize)),i=i.substring(this.maxWebSocketFrameSize),"function"==typeof this.debug&&this.debug("remaining = "+i.length)}},n.prototype._setupHeartbeat=function(n){var e,o,s,u,a,c;if((a=n.version)===r.VERSIONS.V1_1||a===r.VERSIONS.V1_2)return c=function(){var t,e,r,i;for(r=n["heart-beat"].split(","),i=[],t=0,e=r.length;e>t;t++)u=r[t],i.push(parseInt(u));return i}(),o=c[0],e=c[1],0!==this.heartbeat.outgoing&&0!==e&&(s=Math.max(this.heartbeat.outgoing,e),"function"==typeof this.debug&&this.debug("send PING every "+s+"ms"),this.pinger=r.setInterval(s,function(n){return function(){return n.ws.send(t.LF),"function"==typeof n.debug?n.debug(">>> PING"):void 0}}(this))),0!==this.heartbeat.incoming&&0!==o?(s=Math.max(this.heartbeat.incoming,o),"function"==typeof this.debug&&this.debug("check PONG every "+s+"ms"),this.ponger=r.setInterval(s,function(t){return function(){var n;return n=i()-t.serverActivity,n>2*s?("function"==typeof t.debug&&t.debug("did not receive server activity for the last "+n+"ms"),t.ws.close()):void 0}}(this))):void 0},n.prototype._parseConnect=function(){var t,n,e,r;switch(t=1<=arguments.length?o.call(arguments,0):[],r={},t.length){case 2:r=t[0],n=t[1];break;case 3:t[1]instanceof Function?(r=t[0],n=t[1],e=t[2]):(r.login=t[0],r.passcode=t[1],n=t[2]);break;case 4:r.login=t[0],r.passcode=t[1],n=t[2],e=t[3];break;default:r.login=t[0],r.passcode=t[1],n=t[2],e=t[3],r.host=t[4]}return[r,n,e]},n.prototype.connect=function(){var n,s,u,a;return n=1<=arguments.length?o.call(arguments,0):[],a=this._parseConnect.apply(this,n),u=a[0],this.connectCallback=a[1],s=a[2],"function"==typeof this.debug&&this.debug("Opening Web Socket..."),this.ws.onmessage=function(n){return function(r){var o,u,a,c,h,f,p,l,d,g,b,m,v;if(c="undefined"!=typeof ArrayBuffer&&r.data instanceof ArrayBuffer?(o=new Uint8Array(r.data),"function"==typeof n.debug?n.debug("--- got data length: "+o.length):void 0,function(){var t,n,e;for(e=[],t=0,n=o.length;n>t;t++)u=o[t],e.push(String.fromCharCode(u));return e}().join("")):r.data,n.serverActivity=i(),c===t.LF)return void("function"==typeof n.debug&&n.debug("<<< PONG"));for("function"==typeof n.debug&&n.debug("<<< "+c),d=e.unmarshall(n.partialData+c),n.partialData=d.partial,m=d.frames,v=[],g=0,b=m.length;b>g;g++)switch(h=m[g],h.command){case"CONNECTED":"function"==typeof n.debug&&n.debug("connected to server "+h.headers.server),n.connected=!0,n._setupHeartbeat(h.headers),v.push("function"==typeof n.connectCallback?n.connectCallback(h):void 0);break;case"MESSAGE":l=h.headers.subscription,p=n.subscriptions[l]||n.onreceive,p?(a=n,f=h.headers["message-id"],h.ack=function(t){return null==t&&(t={}),a.ack(f,l,t)},h.nack=function(t){return null==t&&(t={}),a.nack(f,l,t)},v.push(p(h))):v.push("function"==typeof n.debug?n.debug("Unhandled received MESSAGE: "+h):void 0);break;case"RECEIPT":v.push("function"==typeof n.onreceipt?n.onreceipt(h):void 0);break;case"ERROR":v.push("function"==typeof s?s(h):void 0);break;default:v.push("function"==typeof n.debug?n.debug("Unhandled frame: "+h):void 0)}return v}}(this),this.ws.onclose=function(t){return function(){var n;return n="Whoops! Lost connection to "+t.ws.url,"function"==typeof t.debug&&t.debug(n),t._cleanUp(),"function"==typeof s?s(n):void 0}}(this),this.ws.onopen=function(t){return function(){return"function"==typeof t.debug&&t.debug("Web Socket Opened..."),u["accept-version"]=r.VERSIONS.supportedVersions(),u["heart-beat"]=[t.heartbeat.outgoing,t.heartbeat.incoming].join(","),t._transmit("CONNECT",u)}}(this)},n.prototype.disconnect=function(t,n){return null==n&&(n={}),this._transmit("DISCONNECT",n),this.ws.onclose=null,this.ws.close(),this._cleanUp(),"function"==typeof t?t():void 0},n.prototype._cleanUp=function(){return this.connected=!1,this.pinger&&r.clearInterval(this.pinger),this.ponger?r.clearInterval(this.ponger):void 0},n.prototype.send=function(t,n,e){return null==n&&(n={}),null==e&&(e=""),n.destination=t,this._transmit("SEND",n,e)},n.prototype.subscribe=function(t,n,e){var r;return null==e&&(e={}),e.id||(e.id="sub-"+this.counter++),e.destination=t,this.subscriptions[e.id]=n,this._transmit("SUBSCRIBE",e),r=this,{id:e.id,unsubscribe:function(){return r.unsubscribe(e.id)}}},n.prototype.unsubscribe=function(t){return delete this.subscriptions[t],this._transmit("UNSUBSCRIBE",{id:t})},n.prototype.begin=function(t){var n,e;return e=t||"tx-"+this.counter++,this._transmit("BEGIN",{transaction:e}),n=this,{id:e,commit:function(){return n.commit(e)},abort:function(){return n.abort(e)}}},n.prototype.commit=function(t){return this._transmit("COMMIT",{transaction:t})},n.prototype.abort=function(t){return this._transmit("ABORT",{transaction:t})},n.prototype.ack=function(t,n,e){return null==e&&(e={}),e["message-id"]=t,e.subscription=n,this._transmit("ACK",e)},n.prototype.nack=function(t,n,e){return null==e&&(e={}),e["message-id"]=t,e.subscription=n,this._transmit("NACK",e)},n}(),r={VERSIONS:{V1_0:"1.0",V1_1:"1.1",V1_2:"1.2",supportedVersions:function(){return"1.1,1.0"}},client:function(t,e){var i,o;return null==e&&(e=["v10.stomp","v11.stomp"]),i=r.WebSocketClass||WebSocket,o=new i(t,e),new n(o)},over:function(t){return new n(t)},Frame:e},"undefined"!=typeof exports&&null!==exports&&(exports.Stomp=r),"undefined"!=typeof window&&null!==window?(r.setInterval=function(t,n){return window.setInterval(n,t)},r.clearInterval=function(t){return window.clearInterval(t)},window.Stomp=r):exports||(self.Stomp=r)}).call(this);